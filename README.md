...
### Add the Gist activity
In the `AndroidManifest.xml` add the following snippet within the application node.
```xml
<activity
    android:name="sh.bourbon.gist.presentation.GistActivity"
